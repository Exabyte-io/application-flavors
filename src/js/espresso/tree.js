...
export default {
    "pw.x": {
        ...
        flavors: {
            ...
            pw_nscf: {
                ...
                results: ["fermi_energy", "band_gaps"],
    ...
    "ph.x": {
        monitors: [monitors.standard_output],
        results: ["phonon_dos", "phonon_dispersions", "zero_point_energy"],
        flavors: {
            ph_path: {
                input: [
                    {
    ...
    "matdyn.x": {
        monitors: [monitors.standard_output],
        results: ["phonon_dos", "phonon_dispersions"],
        flavors: {
            matdyn_grid: {
                input: [
                    {
    ...
    "neb.x": {
        monitors: [monitors.standard_output],
        results: ["reaction_energy_barrier", "reaction_energy_profile"],
        flavors: {
            neb: {
    ...
    "gw.x": {
        monitors: [monitors.standard_output],
        results: ["band_structure", "fermi_energy", "band_gaps"],
        flavors: {
