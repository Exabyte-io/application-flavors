        ...
        espresso: {
            ...
            "gw.x": {
                ...
                flavors: {
                    gw_bands_plasmon_pole: {
                        input: [{ name: "gw_bands_plasmon_pole.in" }],
                        results: ["band_structure", "fermi_energy", "band_gaps"],
                        monitors: ["standard_output"],
                        applicationName: "espresso",
                        executableName: "gw.x",
                    ...
                    gw_bands_full_frequency: {
                        input: [{ name: "gw_bands_full_frequency.in" }],
                        results: ["band_structure", "fermi_energy", "band_gaps"],
                        monitors: ["standard_output"],
                        applicationName: "espresso",
                        executableName: "gw.x",
            ...
            "ph.x": {
                ...
                flavors: {
                    ...
                    ph_single_irr_qpt: {
                        input: [{ name: "ph_single_irr_qpt.in" }],
                        results: [],
                        monitors: ["standard_output"],
                        applicationName: "espresso",
                        executableName: "ph.x",
            ...
            "pp.x": {
                ...
                flavors: {
                    ...
                    pp_electrostatic_potential: {
                        input: [{ name: "pp_electrostatic_potential.in" }],
                        results: [],
                        monitors: ["standard_output"],
                        applicationName: "espresso",
                        executableName: "pp.x",
            ...
            "pw.x": {
                ...
                flavors: {
                    ...
                    pw_scf_bands_hse: {
                        input: [{ name: "pw_scf_bands_hse.in" }],
                        results: [
                            "total_energy",
                            "total_energy_contributions",
                            "pressure",
                    ...
                    pw_bands: {
                        input: [{ name: "pw_bands.in" }],
                        monitors: ["standard_output"],
                        applicationName: "espresso",
                        executableName: "pw.x",
                    },
                    pw_relax: {
                        input: [{ name: "pw_relax.in" }],
                        monitors: [
                            "standard_output",
            ...
            score: {
                ...
                flavors: {
                    score: {
                        ...
                        input: [],
                        monitors: ["standard_output"],
                        applicationName: "exabyteml",
                        executableName: "score",
                    },
                },
            },
            train: {
        ...
        nwchem: {
            nwchem: {
                ...
                flavors: {
                    nwchem_total_energy: {
                        isDefault: true,
                        input: [{ name: "nwchem_total_energy.inp" }],
                        results: ["total_energy", "total_energy_contributions"],
                        monitors: ["standard_output"],
            ...
            python: {
                ...
                flavors: {
                    hello_world: {
                        isDefault: true,
                        input: [
                            { name: "script.py", templateName: "hello_world.py" },
                    ...
                    espresso_xml_get_qpt_irr: {
                        input: [{ name: "espresso_xml_get_qpt_irr.py" }],
                        monitors: ["standard_output"],
                        applicationName: "python",
                        executableName: "python",
                    },
                    espresso_extract_kpoints: {
                        input: [
                            ...
                            { name: "requirements.txt", templateName: "requirements_empty.txt" },
                        ],
                        monitors: ["standard_output"],
                        applicationName: "python",
                        executableName: "python",
                    ...
                    "generic:post_processing:plot:matplotlib": {
                        input: [
                            { name: "plot.py", templateName: "matplotlib_basic.py" },
                            {
                                name: "requirements.txt",
                    ...
                    "generic:processing:find_extrema:scipy": {
                        input: [
                            { name: "find_extrema.py", templateName: "find_extrema.py" },
                            {
                                name: "requirements.txt",
                                templateName: "processing_requirements.txt",
                            },
                    ...
                    "pyml:setup_variables_packages": {
                        input: [
                            { name: "settings.py", templateName: "pyml_settings.py" },
                            { name: "requirements.txt", templateName: "pyml_requirements.txt" },
                        ],
                        monitors: ["standard_output"],
                        applicationName: "python",
                        executableName: "python",
                    ...
                    "pyml:custom": {
                        input: [
                            { name: "pyml_custom.py", templateName: "pyml_custom.py" },
                            { name: "requirements.txt", templateName: "pyml_requirements.txt" },
                        ],
                        monitors: ["standard_output"],
                        applicationName: "python",
                        ...
                        input: [
                            {
                                ...
                                templateName:
                                    "model_extreme_gradboosted_trees_regression_sklearn.py",
                            },
                            { name: "requirements.txt", templateName: "pyml_requirements.txt" },
                        ],
                        results: ["workflow:pyml_predict"],
                    ...
                    "pyml:model:multilayer_perceptron:sklearn": {
                        input: [
                            { name: "model_mlp_sklearn.py", templateName: "model_mlp_sklearn.py" },
                            { name: "requirements.txt", templateName: "pyml_requirements.txt" },
                        ],
                        results: ["workflow:pyml_predict"],
                        monitors: ["standard_output"],
                        ...
                        input: [
                            {
                                ...
                                templateName:
                                    "model_extreme_gradboosted_trees_classification_sklearn.py",
                            },
                            { name: "requirements.txt", templateName: "pyml_requirements.txt" },
                        ],
                        results: ["workflow:pyml_predict"],
        ...
        shell: {
            sh: {
                ...
                flavors: {
                    ...
                    job_espresso_pw_scf: {
                        input: [{ name: "job_espresso_pw_scf.sh" }],
                        monitors: ["standard_output"],
                        applicationName: "shell",
                        executableName: "sh",
                    },
                    espresso_link_outdir_save: {
                        input: [{ name: "espresso_link_outdir_save.sh" }],
                        monitors: ["standard_output"],
                        applicationName: "shell",
                        executableName: "sh",
                    },
                    espresso_collect_dynmat: {
                        input: [{ name: "espresso_collect_dynmat.sh" }],
                        monitors: ["standard_output"],
                        applicationName: "shell",
                        executableName: "sh",
                    },
                    bash_vasp_prepare_neb_images: {
                        isMultiMaterial: true,
                        input: [{ name: "bash_vasp_prepare_neb_images.sh" }],
                        monitors: ["standard_output"],
                        applicationName: "shell",
                        executableName: "sh",
                    },
        ...
        vasp: {
            vasp: {
                ...
                flavors: {
                    vasp: {
                        isDefault: true,
                        input: [{ name: "INCAR" }, { name: "KPOINTS" }, { name: "POSCAR" }],
                        results: [
                            "total_energy",
                            "total_energy_contributions",
                            "pressure",
                    ...
                    vasp_bands: {
                        input: [
                            { name: "INCAR", templateName: "INCAR_BANDS" },
                            { name: "KPOINTS", templateName: "KPOINTS_BANDS" },
                            { name: "POSCAR", templateName: "" },
                        ],
                        results: ["band_structure"],
                        monitors: ["standard_output", "convergence_electronic"],
                        applicationName: "vasp",
                    ...
                    vasp_nscf: {
                        input: [
                            { name: "INCAR", templateName: "INCAR_BANDS" },
                            { name: "KPOINTS", templateName: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR" },
                        ],
                    ...
                    vasp_hse: {
                        isDefault: false,
                        input: [
                            { name: "INCAR", templateName: "INCAR_HSE" },
                            { name: "KPOINTS" },
                            { name: "POSCAR" },
                        ],
                        results: [
                    ...
                    vasp_bands_hse: {
                        isDefault: false,
                        input: [
                            { name: "INCAR", templateName: "INCAR_BANDS_HSE" },
                            { name: "KPOINTS", templateName: "KPOINTS_BANDS" },
                            { name: "POSCAR", templateName: "" },
                        ],
                        results: ["band_structure"],
                    ...
                    vasp_relax: {
                        input: [
                            { name: "INCAR", templateName: "INCAR_RELAX" },
                            { name: "KPOINTS", templateName: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR" },
                        ],
                        results: [
                    ...
                    vasp_vc_relax: {
                        input: [
                            { name: "INCAR", templateName: "INCAR_VC_RELAX" },
                            { name: "KPOINTS", templateName: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR" },
                        ],
                        results: [
                    ...
                    vasp_zpe: {
                        input: [
                            { name: "INCAR", templateName: "INCAR_ZPE" },
                            { name: "KPOINTS", templateName: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR" },
                        ],
                        results: [
                    ...
                    vasp_kpt_conv: {
                        input: [
                            { name: "INCAR", templateName: "INCAR" },
                            { name: "KPOINTS", templateName: "KPOINTS_CONV" },
                            { name: "POSCAR", templateName: "POSCAR" },
                        ],
                        results: [
                            "total_energy",
                    ...
                    vasp_neb: {
                        isMultiMaterial: true,
                        input: [
                            { name: "INCAR", templateName: "INCAR_NEB" },
                            { name: "KPOINTS", templateName: "KPOINTS" },
                        ],
                        results: ["reaction_energy_barrier", "reaction_energy_profile"],
                        monitors: ["standard_output"],
                    ...
                    vasp_neb_initial: {
                        isMultiMaterial: true,
                        input: [
                            { name: "INCAR", templateName: "INCAR_NEB_INITIAL_FINAL" },
                            { name: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR_NEB_INITIAL" },
                        ],
                        results: [
                            "total_energy",
                            "total_energy_contributions",
                    ...
                    vasp_neb_final: {
                        ...
                        input: [
                            { name: "INCAR", templateName: "INCAR_NEB_INITIAL_FINAL" },
                            { name: "KPOINTS" },
                            { name: "POSCAR", templateName: "POSCAR_NEB_FINAL" },
                        ],
                        results: [
                            "total_energy",
                            "total_energy_contributions",
