...
export default () => {
    const allAssets = [
        ...
        {
            content: readAssetFile("python/generic", "processing:find_extrema.pyi"),
        ...
        {
            content: readAssetFile("python/generic", "requirements.j2.txt"),
        ...
        },
        {
            ...
            contextProviders: ["MLSettingsDataManager"],
            applicationName,
            executableName,
        },
        {
        ...
        },
        {
            ...
            contextProviders: ["MLTrainTestSplitDataManager"],
            applicationName,
            executableName,
        },
        {
